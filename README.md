...
**[Background]** Time-space traffic diagram (or spatiotemporal speed contour diagrams) describe how traffic speed changes over time and space. They are commonly constructed by averaging speed observations within **rectangular cells**.
